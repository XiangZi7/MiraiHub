...
export const COMMAND_GROUPS: CommandGroup[] = [
  {
    ...
    label: 'Connections',
    items: [
      { id: 'c1', label: 'Connect to Server', icon: 'lucide:server', shortcut: '⌘⇧S' },
      { id: 'c2', label: 'New Database Connection', icon: 'lucide:database', shortcut: '⌘⇧D' },
      { id: 'c3', label: 'New Terminal', icon: 'lucide:square-terminal', shortcut: '⌘T' },
    ],
  },
  {
    id: 'actions',
    label: 'Actions',
    items: [
      { id: 'a1', label: 'Split Terminal', icon: 'lucide:columns-2', shortcut: '⌘\\' },
      { id: 'a2', label: 'Open Files', icon: 'lucide:folder-open', shortcut: '⌘O' },
      { id: 'a3', label: 'Run SQL', icon: 'lucide:play', shortcut: '⌘⏎' },
      { id: 'a4', label: 'Upload Files', icon: 'lucide:upload', shortcut: '⌘⇧U' },
    ],
  },
  {
    id: 'search',
    label: 'Search',
    items: [
      { id: 's1', label: 'Search Servers', icon: 'lucide:search', shortcut: '⌘F' },
      { id: 's2', label: 'Global Search', icon: 'lucide:scan-search', shortcut: '⌘⇧F' },
    ],
  },
]
