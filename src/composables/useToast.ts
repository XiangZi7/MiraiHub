...
export const toast = Object.assign(
  (input: ToastInput) => useNotificationsStore(pinia).show('info', input),
  {
    success: (input: ToastInput) =>
      useNotificationsStore(pinia).show('success', input),
    error: (input: ToastInput) =>
      useNotificationsStore(pinia).show('error', input),
    warning: (input: ToastInput) =>
      useNotificationsStore(pinia).show('warning', input),
    info: (input: ToastInput) =>
      useNotificationsStore(pinia).show('info', input),
