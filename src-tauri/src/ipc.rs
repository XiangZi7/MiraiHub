...
pub fn handler() -> impl Fn(Invoke<Wry>) -> bool + Send + Sync + 'static {
    tauri::generate_handler![
        ...
        agent::ai_list_mcp_servers,
        agent::ai_save_mcp_server,
        agent::ai_delete_mcp_server,
        agent::ai_test_mcp_server,
        agent::ai_start,
        agent::ai_send,
        agent::ai_step,
        agent::ai_respond,
        ...
        platform::column_tags::open_column_tags_window,
        platform::column_tags::column_tags_target,
        platform::column_tags::column_tags_submit,
